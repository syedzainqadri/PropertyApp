...
FeaturedListings featuredListingsFromJson(String str) =>
    FeaturedListings.fromJson(json.decode(str));
...
class FeaturedListings {
  ...
  factory FeaturedListings.fromJson(Map<String, dynamic> json) =>
      FeaturedListings(
