...
List<AllChats> allChatsFromJson(String str) =>
    List<AllChats>.from(json.decode(str).map((x) => AllChats.fromJson(x)));
...
class Listing {
  ...
  factory Listing.fromJson(Map<String, dynamic> json) => Listing(
        ...
        amount: json["amount"],
        location: List<Category>.from(
            json["location"].map((x) => Category.fromJson(x))),
