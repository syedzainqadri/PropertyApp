...
AllListings allListingsFromJson(String str) => AllListings.fromJson(json.decode(str));
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        priceUnits: List<PriceUnitElement>.from(json["price_units"].map((x) => PriceUnitElement.fromJson(x))),
        ...
        promotions: List<Promotion>.from(json["promotions"].map((x) => promotionValues.map![x])),
...
final whatsappNumberValues = EnumValues({
    ...
    "5454545454": WhatsappNumber.THE_5454545454
});
...
enum SrcsetSizes { MAX_WIDTH_1240_PX_100_VW_1240_PX, MAX_WIDTH_1170_PX_100_VW_1170_PX, MAX_WIDTH_612_PX_100_VW_612_PX, MAX_WIDTH_509_PX_100_VW_509_PX, MAX_WIDTH_1600_PX_100_VW_1600_PX, MAX_WIDTH_1920_PX_100_VW_1920_PX }

final srcsetSizesValues = EnumValues({
    "(max-width: 1170px) 100vw, 1170px": SrcsetSizes.MAX_WIDTH_1170_PX_100_VW_1170_PX,
    "(max-width: 1240px) 100vw, 1240px": SrcsetSizes.MAX_WIDTH_1240_PX_100_VW_1240_PX,
    "(max-width: 1600px) 100vw, 1600px": SrcsetSizes.MAX_WIDTH_1600_PX_100_VW_1600_PX,
    "(max-width: 1920px) 100vw, 1920px": SrcsetSizes.MAX_WIDTH_1920_PX_100_VW_1920_PX,
...
class PriceUnitElement {
    ...
    factory PriceUnitElement.fromJson(Map<String, dynamic> json) => PriceUnitElement(
...
final pricingTypeValues = EnumValues({
    "price": PricingType.PRICE,
    "range": PricingType.RANGE
});
