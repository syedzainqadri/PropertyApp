// ignore_for_file: prefer_typing_uninitialized_variables, unnecessary_null_in_if_null_operators
import 'dart:convert';

ListingConfiguration listingConfigurationFromJson(String str) =>
    ListingConfiguration.fromJson(json.decode(str));
...
class ListingConfiguration {
  ...
  factory ListingConfiguration.fromJson(Map<String, dynamic> json) =>
      ListingConfiguration(
